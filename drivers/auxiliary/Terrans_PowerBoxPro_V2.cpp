...
// We declare an auto pointer to TerransPowerBoxV2.
static std::unique_ptr<TerransPowerBoxV2> terranspowerboxv2(new TerransPowerBoxV2());
...
TerransPowerBoxV2::TerransPowerBoxV2() : WI(this)
{
    setVersion(1, 0);
}

bool TerransPowerBoxV2::initProperties()
{
...
bool TerransPowerBoxV2::updateProperties()
{
...
bool TerransPowerBoxV2::saveConfigItems(FILE *fp)
{
...
bool TerransPowerBoxV2::Handshake()
{
    char res[CMD_LEN] = {0};
    if (isSimulation())
    {
...
const char *TerransPowerBoxV2::getDefaultName()
{
    LOG_INFO("GET Name");
    return "TerransPowerBoxV2";
}

bool TerransPowerBoxV2::ISNewSwitch(const char *dev, const char *name, ISState *states, char *names[], int n)
{
...
bool TerransPowerBoxV2::ISNewText(const char * dev, const char * name, char * texts[], char * names[], int n)
{
...
bool TerransPowerBoxV2::sendCommand(const char * cmd, char * res)
{
...
void TerransPowerBoxV2::TimerHit()
{
...
void TerransPowerBoxV2::Get_State()
{    
    char res[CMD_LEN] = {0};
    if(get_count == 0)
    {
...
bool TerransPowerBoxV2::processButtonSwitch(const char *dev, const char *name, ISState *states, char *names[],int n)
{
    char res[CMD_LEN] = {0};
    if (dev != nullptr && strcmp(dev, getDeviceName()) == 0)
    {        
